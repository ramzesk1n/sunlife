              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {(['telegram', 'whatsapp', 'max', 'phone'] as const).map((method) => (
                      <button
                        key={method}
                        type="button"
                      ...
                      >
                        ...
                        {method === 'max' && (
                          <span className="flex items-center justify-center gap-1.5">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M12 3C6.5 3 2 7.05 2 12c0 2.45 1.1 4.7 2.9 6.3L4 22l3.95-1.65c1.25.5 2.6.75 4.05.75 5.5 0 10-4.05 10-9S17.5 3 12 3Z"/><path d="M7 15V9.5l2.5 3.5 2.5-3.5V15"/><path d="M14.25 15l2-5.5 2 5.5"/><path d="M14.9 13.25h2.7"/></svg>
                            Max
                          </span>
                        )}
                        {method === 'phone' && (
