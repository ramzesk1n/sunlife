      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 relative">
          {isHome ? (
            <Link
              to="/"
              className="w-full sm:w-auto px-8 py-4 bg-gold-dark text-cream font-display font-light uppercase tracking-wider rounded-2xl hover:bg-gold-darker transition-colors duration-300 inline-flex items-center justify-center"
            >
              {cta.label}
            </Link>
          ) : (
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 border border-gold-primary text-gold-dark font-display font-light uppercase tracking-wider rounded-2xl hover:bg-gold-dark hover:text-cream transition-all duration-300 inline-flex items-center justify-center gap-2"
            >
