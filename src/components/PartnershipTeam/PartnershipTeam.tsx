...
import { partnershipTeam } from '../../content/partnership';
...
export default function PartnershipTeam() {
    ...
    const animate = () => {
      if (!isPaused) {
        ...
        if (firstChild) {
          ...
          const halfWidth = (partnershipTeam.length * totalItemWidth);
  ...
  const duplicatedTeam = [...partnershipTeam, ...partnershipTeam];
