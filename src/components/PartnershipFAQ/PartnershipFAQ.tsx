...
export default function PartnershipFAQ() {
  ...
  const faqItems = faqData.categories.partnership;
          ...
          {faqItems.map((item) => (
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-between p-5 text-left hover:bg-cream-2/50 transition-colors duration-200 gap-4"
                aria-expanded={openId === item.id}
              >
                <span className="font-display font-semibold text-gold-dark pr-4 text-left uppercase tracking-wider text-base md:text-lg leading-snug">
                  {item.question}
                </span>
                <motion.span
